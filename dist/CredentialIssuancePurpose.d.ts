...
declare const CredentialIssuancePurpose_base: any;
/**
 * Creates a proof purpose that will validate whether or not the verification
 * method in a proof was authorized by its declared controller for the
 * proof's purpose.
 */
declare class CredentialIssuancePurpose extends CredentialIssuancePurpose_base {
    [x: string]: any;
    /**
     ...
     */
    validate(proof: object, { document, suite, verificationMethod, documentLoader, expansionMap }: {
        document: object;
        suite: object;
